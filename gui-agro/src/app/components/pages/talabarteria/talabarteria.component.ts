...
@Component({
  selector: 'app-talabarteria',
  templateUrl: './talabarteria.component.html',
  styleUrls: ['./talabarteria.component.scss']
})
export class TalabarteriaComponent implements OnInit {

  public pro: Producto;
  public listapro: any = [];
  public buscarnom =  "talabarteria"; 
